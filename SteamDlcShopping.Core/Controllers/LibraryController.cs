...
public static class LibraryController
{
    ...
    public static int FailedGames => _library is null ? 0 : _library.Games is null ? 0 : _library.Games.Count(x => x.FailedFetch);
    ...
    internal static void Logout() => _library = null;
