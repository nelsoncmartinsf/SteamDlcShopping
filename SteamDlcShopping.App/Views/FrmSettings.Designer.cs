namespace SteamDlcShopping.App.Views {
	partial class FrmSettings {
		...
		private void InitializeComponent() {
			...
			btnSave.Location = new Point(232, 278);
			...
			btnCancel.Location = new Point(313, 278);
			...
			chkUseMemeLoading.Location = new Point(28, 245);
			...
			ddlPageOpener.Items.AddRange(new object[] { "Browser", "Steam" });
			...
			lblPageOpener.Size = new Size(78, 15);
			lblPageOpener.TabIndex = 11;
			lblPageOpener.Text = "Open page in";
			// 
			// FrmSettings
			// 
